...
const Login = () => {
  ...
  const { setShowLogin, backendUrl, setToken, loadCreditsData } =
  ...
  const onSubmitHandler = async (e) => {
    ...
    try {
      ...
      if (data.success) {
        ...
        // Update token state - this will trigger useEffect in AppContext
        setToken(data.token);
        ...
        // Give a moment for token state to update, then load credits
        setTimeout(() => {
          loadCreditsData();
        }, 200);
      } else {
